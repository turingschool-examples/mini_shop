...
RSpec.describe "user sees all items" do
  describe "they visit /items" do
    it "displays all items" do
      ...
      # PITA PAN
      item_3 = Item.create!(name: "Stuffed Pita",description: "Veggies and hummus", price: 12.50, image: 'https://www.landolakes.com/RecipeManagementSystem/media/Recipe-Media-Files/Recipes/Retail/DesktopImages/12565.jpg', status: "inactive", inventory: 8, merchant_id: merchant_3.id)
      item_4 = Item.create!(name: "Pita Pizza", description: "Sauce and cheese", price: 10.50, image: 'https://purewows3.imgix.net/images/articles/2019_04/pita-pizzas-domestic-greek-recipe-921.jpg?auto=format,compress&cs=strip', status: "active", inventory: 18, merchant_id: merchant_3.id)
      item_5 = Item.create!(name: "Pita Chips", description: "Baked and salted", price: 6.00, image: 'https://img.buzzfeed.com/thumbnailer-prod-us-east-1/9c7590b4356c405ca11794c355ddac48/fb.jpg', status: "active", inventory: 0, merchant_id: merchant_3.id)
