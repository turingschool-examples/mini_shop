...
describe "As a visitor" do
  before :each do
    ...
    @item_1 = @merchant_1.items.create(name: "flylow chemical", description: "Mens ski pant", price: 325, image: "how do i do this" , status: "Active", inventory: 12, merchant_name: "")
    @item_2 = @merchant_2.items.create(name: "ON3P Jeffrey", description: "Big mountain ski", price: 699, image: "how do i do this" , status: "Active", inventory: 9, merchant_name: "")
end
