...
RSpec.describe "Items index page", type: :feature do
  it "user can see all items" do
    ...
    expect(page).to have_content(item_2.image_url)
    expect(page).to have_content(item_3.image_url)
    expect(page).to have_content(item_4.image_url)
    ...
    expect(page).to have_content(item_4.merchant.name)
  end
end
