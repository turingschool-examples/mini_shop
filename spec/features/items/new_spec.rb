...
describe "Item Creation Page" do
  it "has a form to fill in with item information" do
    ...
    expect(page).to have_css("img[src*='https://www.google.com/url?sa=i&source=images&cd=&ved=2ahUKEwjpk5PY-IXkAhWDrZ4KHckSAHUQjRx6BAgBEAQ&url=http%3A%2F%2Ftestcreative.co.uk%2F&psig=AOvVaw3ubvA6c5cMhxXeXiEvzELG&ust=1565995148137904']")
