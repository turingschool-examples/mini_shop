...
RSpec.describe "Items index" do
  describe "as a visitor" do
    it "has all the items and their name, description, price
        ...
        expect(page).to_not have_content(blanket.name)
        expect(page).to_not have_content(blanket.description)
        expect(page).to_not have_content(blanket.price)
        expect(page).to_not have_content(blanket.status)
        expect(page).to_not have_content(blanket.inventory)
